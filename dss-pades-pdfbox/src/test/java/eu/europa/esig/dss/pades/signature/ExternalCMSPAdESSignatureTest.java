...
public class ExternalCMSPAdESSignatureTest extends AbstractPAdESTestSignature {
	...
	protected DSSDocument sign() {
		...
		byte[] documentDigest = service.computeDocumentDigest(documentToSign, signatureParameters, false);
