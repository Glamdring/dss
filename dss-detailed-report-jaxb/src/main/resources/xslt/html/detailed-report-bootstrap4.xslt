    ...
    <xsl:template match="/dss:DetailedReport">
    	<div>
		    ...
		    <div>
		    	...
		    	<!--<xsl:comment>Generated by DSS v.5.5</xsl:comment>-->
		...
		<div>
    		...
    		<div>
	    		...
	    		<xsl:attribute name="data-target">#collapsePolicy</xsl:attribute>
		       	<xsl:attribute name="data-toggle">collapse</xsl:attribute>
    			Validation Policy : Evrotrust validation policy OID=1.3.6.1.4.1.47272.2.9 <!--<xsl:value-of select="dss:PolicyName"/>-->
	        </div>
    		<div>
