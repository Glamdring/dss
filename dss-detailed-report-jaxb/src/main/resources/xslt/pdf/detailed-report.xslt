			...
			<fo:page-sequence>
				...
				<fo:flow>
					...
					<fo:block>
						...
						Electronically signed document is validated in accordance with the Evrotrust validation policy OID=1.3.6.1.4.1.47272.2.9. 
						For further details please read Evrotrust qualified validation practice and policy.
					</fo:block>							
